...
def move_between_workflows(main_window: main.MainWindow, to_page: int, dims: Optional[str] = None):
    """
    ...
    if workflow_key_name == "SEMANTIC_SEG":
        ...
        main_window.ui.train_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.train_workflow_specific_tab_semantic_seg_page
        )
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_semantic_seg_page
        )
        # Train page
    ...
    # Instance seg
        ...
        main_window.ui.train_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.train_workflow_specific_tab_instance_seg_page
        )
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_instance_seg_page
        )
        # Train page
        main_window.ui.train_gt_label.setText("Input label folder")
        main_window.ui.validation_data_gt_label.setText("Input label folder")
    ...
    # Detection
        ...
        main_window.ui.train_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.train_workflow_specific_tab_detection_page
        )
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_detection_page
        )
        # Train page
    ...
    # Denoising
        ...
        main_window.ui.train_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.train_workflow_specific_tab_denoising_page
        )
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_denoising_page
        )
        # Train page
        main_window.ui.transformers_label.setText("UNETR")
        # Test page
    ...
    # Super resolution
        ...
        main_window.ui.train_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.train_workflow_specific_tab_sr_page
        )
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_sr_page
        )
        # Train page
    ...
    # Self-supevised learning
        ...
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_ssl_page
        )
        # Train page
    ...
    # Classification
        ...
        main_window.ui.train_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.train_workflow_specific_tab_classification_page
        )
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_classification_page
        )
        # Test page
    ...
    # Image to image
        ...
        main_window.ui.test_workflow_specific_tab_stackedWidget.setCurrentWidget(
            main_window.ui.test_workflow_specific_tab_i2i_page
        )
        # Train page
    ...
    main_window.condition_db.combobox_hide_visible_action(
        main_window,
        [
...
def oninit_checks(main_window: main.MainWindow):
    """
    ...
    if main_window.cfg.settings["docker_found"]:
        ...
        main_window.ui.docker_status_label.setText(
    ...
    if len(main_window.cfg.settings["GPUs"]) > 0:
        if len(main_window.cfg.settings["GPUs"]) == 1:
            ...
            main_window.ui.gpu_status_label.setText(
                "{} NVIDIA GPU cards found".format(len(main_window.cfg.settings["GPUs"]))
            )
        main_window.ui.gpu_head_label.setText("GPU dependency")
        main_window.ui.gpu_frame.setStyleSheet(
...
def create_yaml_file(main_window: main.MainWindow) -> Tuple[bool, bool]:
    """
    ...
    if not os.path.exists(main_window.cfg.settings["yaml_config_file_path"]):
        main_window.dialog_exec(
            "The directory '{}' where the configuration file is going to be saves does not exist.".format(
                main_window.cfg.settings["yaml_config_file_path"]
            ),
    ...
    biapy_config["PROBLEM"]["TYPE"] = main_window.cfg.settings["workflow_key_names"][
        main_window.cfg.settings["selected_workflow"]
    ]
    ...
    if workflow_key_name == "SEMANTIC_SEG":
        if int(get_text(main_window.ui.PROBLEM__SEMANTIC_SEG__IGNORE_CLASS_ID__INPUT)) != 0:
            ...
            biapy_config["PROBLEM"]["SEMANTIC_SEG"]["IGNORE_CLASS_ID"] = int(
                get_text(main_window.ui.PROBLEM__SEMANTIC_SEG__IGNORE_CLASS_ID__INPUT)
            )
    ...
    ### INSTANCE_SEG
        ...
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_CHANNELS__INPUT) == "Binary mask + Contours":
            ...
            get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_CHANNELS__INPUT)
        ...
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_CHANNEL_WEIGHTS__INPUT) != (1, 1):
            biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_CHANNEL_WEIGHTS"] = get_text(
                main_window.ui.PROBLEM__INSTANCE_SEG__DATA_CHANNEL_WEIGHTS__INPUT
            )
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_CONTOUR_MODE__INPUT) != "thick":
            biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_CONTOUR_MODE"] = get_text(
                main_window.ui.PROBLEM__INSTANCE_SEG__DATA_CONTOUR_MODE__INPUT
            )
        ...
        biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_TYPE"] = get_text(
            main_window.ui.PROBLEM__INSTANCE_SEG__DATA_MW_TH_TYPE__INPUT
        )
        if biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_TYPE"] == "manual":
            if "B" in problem_channels:
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_BINARY_MASK"] = float(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_MW_TH_BINARY_MASK__INPUT)
                )
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_FOREGROUND"] = float(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_MW_TH_FOREGROUND__INPUT)
                )
            if "C" in problem_channels:
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_CONTOUR"] = float(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_MW_TH_CONTOUR__INPUT)
                )
            if "D" in problem_channels:
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_DISTANCE"] = float(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_MW_TH_DISTANCE__INPUT)
                )
            ...
            if "P" in problem_channels:
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_MW_TH_POINTS"] = float(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_MW_TH_POINTS__INPUT)
                )
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_REMOVE_BEFORE_MW__INPUT) == "Yes":
            ...
            biapy_config["PROBLEM"]["INSTANCE_SEG"]["DATA_REMOVE_SMALL_OBJ_BEFORE"] = int(
                get_text(main_window.ui.PROBLEM__INSTANCE_SEG__DATA_REMOVE_SMALL_OBJ_BEFORE__INPUT)
            )
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__SEED_MORPH_SEQUENCE__INPUT) != "[]":
            try:
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["SEED_MORPH_SEQUENCE"] = ast.literal_eval(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__SEED_MORPH_SEQUENCE__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with instance segmentation seed morph sequence field (PROBLEM.INSTANCE_SEG.SEED_MORPH_SEQUENCE). Please check its syntax!",
                    reason="error",
                )
                return True, False
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__SEED_MORPH_RADIUS__INPUT) != "[]":
            try:
                biapy_config["PROBLEM"]["INSTANCE_SEG"]["SEED_MORPH_RADIUS"] = ast.literal_eval(
                    get_text(main_window.ui.PROBLEM__INSTANCE_SEG__SEED_MORPH_RADIUS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with instance segmentation seed morph radius field (PROBLEM.INSTANCE_SEG.SEED_MORPH_RADIUS). Please check its syntax!",
                    reason="error",
                )
                return True, False
        if get_text(main_window.ui.PROBLEM__INSTANCE_SEG__ERODE_AND_DILATE_FOREGROUND__INPUT) == "Yes":
            ...
            biapy_config["PROBLEM"]["INSTANCE_SEG"]["FORE_EROSION_RADIUS"] = int(
                get_text(main_window.ui.PROBLEM__INSTANCE_SEG__FORE_EROSION_RADIUS__INPUT)
            )
            biapy_config["PROBLEM"]["INSTANCE_SEG"]["FORE_DILATION_RADIUS"] = int(
                get_text(main_window.ui.PROBLEM__INSTANCE_SEG__FORE_DILATION_RADIUS__INPUT)
            )
    ...
    ### DETECTION
        ...
        try:
            biapy_config["PROBLEM"]["DETECTION"]["CENTRAL_POINT_DILATION"] = ast.literal_eval(
                get_text(main_window.ui.PROBLEM__DETECTION__CENTRAL_POINT_DILATION__INPUT)
            )
        except:
            main_window.dialog_exec(
                "There was an error with detection central point dilation field (PROBLEM.DETECTION.CENTRAL_POINT_DILATION). Please check its syntax!",
                reason="error",
            )
            return True, False
        biapy_config["PROBLEM"]["DETECTION"]["CHECK_POINTS_CREATED"] = (
            True if get_text(main_window.ui.PROBLEM__DETECTION__CHECK_POINTS_CREATED__INPUT) == "Yes" else False
        )
        if (
            get_text(main_window.ui.PROBLEM__DETECTION__DATA_CHECK_MW__INPUT) == "Yes"
            and get_text(main_window.ui.TEST__POST_PROCESSING__DET_WATERSHED__INPUT) == "Yes"
        ):
    ...
    ### DENOISING
        ...
        biapy_config["PROBLEM"]["DENOISING"]["N2V_PERC_PIX"] = float(
            get_text(main_window.ui.PROBLEM__DENOISING__N2V_PERC_PIX__INPUT)
        )
        biapy_config["PROBLEM"]["DENOISING"]["N2V_MANIPULATOR"] = get_text(
            main_window.ui.PROBLEM__DENOISING__N2V_MANIPULATOR__INPUT
        )
        biapy_config["PROBLEM"]["DENOISING"]["N2V_NEIGHBORHOOD_RADIUS"] = int(
            get_text(main_window.ui.PROBLEM__DENOISING__N2V_NEIGHBORHOOD_RADIUS__INPUT)
        )
        biapy_config["PROBLEM"]["DENOISING"]["N2V_STRUCTMASK"] = (
            True if get_text(main_window.ui.PROBLEM__DENOISING__N2V_STRUCTMASK__INPUT) == "Yes" else False
        )

    ### SUPER_RESOLUTION
    elif workflow_key_name == "SUPER_RESOLUTION":
        biapy_config["PROBLEM"]["SUPER_RESOLUTION"] = {}
        biapy_config["PROBLEM"]["SUPER_RESOLUTION"]["UPSCALING"] = get_text(
            main_window.ui.PROBLEM__SUPER_RESOLUTION__UPSCALING__INPUT
        )

    ### SELF_SUPERVISED
    elif workflow_key_name == "SELF_SUPERVISED":
        biapy_config["PROBLEM"]["SELF_SUPERVISED"] = {}
        biapy_config["PROBLEM"]["SELF_SUPERVISED"]["PRETEXT_TASK"] = get_text(
            main_window.ui.PROBLEM__SELF_SUPERVISED__PRETEXT_TASK__INPUT
        )
        if get_text(main_window.ui.PROBLEM__SELF_SUPERVISED__PRETEXT_TASK__INPUT) == "crappify":
            biapy_config["PROBLEM"]["SELF_SUPERVISED"]["RESIZING_FACTOR"] = int(
                get_text(main_window.ui.PROBLEM__SELF_SUPERVISED__RESIZING_FACTOR__INPUT)
            )
            biapy_config["PROBLEM"]["SELF_SUPERVISED"]["NOISE"] = float(
                get_text(main_window.ui.PROBLEM__SELF_SUPERVISED__NOISE__INPUT)
            )

    ### IMAGE_TO_IMAGE
    elif workflow_key_name == "IMAGE_TO_IMAGE":
        biapy_config["PROBLEM"]["IMAGE_TO_IMAGE"] = {}
        biapy_config["PROBLEM"]["IMAGE_TO_IMAGE"]["MULTIPLE_RAW_ONE_TARGET_LOADER"] = (
            True
            if get_text(main_window.ui.PROBLEM__IMAGE_TO_IMAGE__MULTIPLE_RAW_ONE_TARGET_LOADER__INPUT) == "Yes"
            else False
        )
    ...
    if (
        get_text(main_window.ui.DATA__PREPROCESS__TRAIN__INPUT) == "Yes"
        or get_text(main_window.ui.DATA__PREPROCESS__VAL__INPUT) == "Yes"
    ):
        preprocess_done = True
        biapy_config["DATA"]["PREPROCESS"] = {}
        biapy_config["DATA"]["PREPROCESS"]["TRAIN"] = (
            True if get_text(main_window.ui.DATA__PREPROCESS__TRAIN__INPUT) == "Yes" else False
        )
        if biapy_config["DATA"]["PREPROCESS"]["TRAIN"] and get_text(main_window.ui.DATA__VAL__TYPE__INPUT) in [
            "Extract from train (cross validation)",
            "Extract from train (split training)",
        ]:
            biapy_config["DATA"]["PREPROCESS"]["VAL"] = True
        else:
            biapy_config["DATA"]["PREPROCESS"]["VAL"] = (
                True if get_text(main_window.ui.DATA__PREPROCESS__VAL__INPUT) == "Yes" else False
            )
        if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__ENABLE__INPUT) == "Yes":
            ...
            biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["OUTPUT_SHAPE"] = get_text(
                main_window.ui.DATA__PREPROCESS__RESIZE__OUTPUT_SHAPE__INPUT
            )
            order = 1
            ...
            biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["MODE"] = get_text(
                main_window.ui.DATA__PREPROCESS__RESIZE__MODE__INPUT
            )
            biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["CVAL"] = float(
                get_text(main_window.ui.DATA__PREPROCESS__RESIZE__CVAL__INPUT)
            )
            biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["CLIP"] = (
                True if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__CLIP__INPUT) else False
            )
            biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["PRESERVE_RANGE"] = (
                True if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__PRESERVE_RANGE__INPUT) else False
            )
            biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["ANTI_ALIASING"] = (
                True if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__ANTI_ALIASING__INPUT) else False
            )
        ...
        if get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__ENABLE__INPUT) == "Yes":
            ...
            biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["SIGMA"] = int(
                get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__SIGMA__INPUT)
            )
            biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["MODE"] = get_text(
                main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__MODE__INPUT
            )
            if get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__CHANNEL_AXIS__INPUT) != "":
                biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["CHANNEL_AXIS"] = int(
                    get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__CHANNEL_AXIS__INPUT)
                )
        ...
        if get_text(main_window.ui.DATA__PREPROCESS__MEDIAN_BLUR__ENABLE__INPUT) == "Yes":
            ...
            try:
                biapy_config["DATA"]["PREPROCESS"]["MEDIAN_BLUR"]["KERNEL_SIZE"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__PREPROCESS__MEDIAN_BLUR__KERNEL_SIZE__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with preprocessing median blur kernel size field (DATA.PREPROCESS.MEDIAN_BLUR.KERNEL_SIZE). Please check its syntax!",
                    reason="error",
                )
                return True, False
        ...
        if get_text(main_window.ui.DATA__PREPROCESS__MATCH_HISTOGRAM__ENABLE__INPUT) == "Yes":
            ...
            biapy_config["DATA"]["PREPROCESS"]["MATCH_HISTOGRAM"]["REFERENCE_PATH"] = get_text(
                main_window.ui.DATA__PREPROCESS__MATCH_HISTOGRAM__REFERENCE_PATH__INPUT, strip=False
            )
        ...
        if get_text(main_window.ui.DATA__PREPROCESS__CLAHE__ENABLE__INPUT) == "Yes":
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__CLAHE__KERNEL_SIZE__INPUT) != "":
                biapy_config["DATA"]["PREPROCESS"]["CLAHE"]["KERNEL_SIZE"] = int(
                    get_text(main_window.ui.DATA__PREPROCESS__CLAHE__KERNEL_SIZE__INPUT)
                )
            biapy_config["DATA"]["PREPROCESS"]["CLAHE"]["CLIP_LIMIT"] = float(
                get_text(main_window.ui.DATA__PREPROCESS__CLAHE__CLIP_LIMIT__INPUT)
            )
        ...
        if get_text(main_window.ui.DATA__PREPROCESS__CANNY__ENABLE__INPUT) == "Yes":
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__CANNY__LOW_THRESHOLD__INPUT) != "":
                biapy_config["DATA"]["PREPROCESS"]["CANNY"]["LOW_THRESHOLD"] = float(
                    get_text(main_window.ui.DATA__PREPROCESS__CANNY__LOW_THRESHOLD__INPUT)
                )
            if get_text(main_window.ui.DATA__PREPROCESS__CANNY__HIGH_THRESHOLD__INPUT) != "":
                biapy_config["DATA"]["PREPROCESS"]["CANNY"]["HIGH_THRESHOLD"] = float(
                    get_text(main_window.ui.DATA__PREPROCESS__CANNY__HIGH_THRESHOLD__INPUT)
                )
    ...
    if get_text(main_window.ui.DATA__PREPROCESS__TEST__INPUT) == "Yes":
        if not preprocess_done:
            biapy_config["DATA"]["PREPROCESS"] = {}
        biapy_config["DATA"]["PREPROCESS"]["TEST"] = (
            True if get_text(main_window.ui.DATA__PREPROCESS__TEST__INPUT) == "Yes" else False
        )
        if not preprocess_done:
            if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__ENABLE__TEST__INPUT) == "Yes":
                ...
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["ENABLE"] = True
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["OUTPUT_SHAPE"] = get_text(
                    main_window.ui.DATA__PREPROCESS__RESIZE__OUTPUT_SHAPE__TEST__INPUT
                )
                order = 1
                ...
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["ORDER"] = order
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["MODE"] = get_text(
                    main_window.ui.DATA__PREPROCESS__RESIZE__MODE__TEST__INPUT
                )
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["CVAL"] = float(
                    get_text(main_window.ui.DATA__PREPROCESS__RESIZE__CVAL__TEST__INPUT)
                )
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["CLIP"] = (
                    True if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__CLIP__TEST__INPUT) else False
                )
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["PRESERVE_RANGE"] = (
                    True if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__PRESERVE_RANGE__TEST__INPUT) else False
                )
                biapy_config["DATA"]["PREPROCESS"]["RESIZE"]["ANTI_ALIASING"] = (
                    True if get_text(main_window.ui.DATA__PREPROCESS__RESIZE__ANTI_ALIASING__TEST__INPUT) else False
                )
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__ENABLE__TEST__INPUT) == "Yes":
                ...
                biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["ENABLE"] = True
                biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["SIGMA"] = int(
                    get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__SIGMA__TEST__INPUT)
                )
                biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["MODE"] = get_text(
                    main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__MODE__TEST__INPUT
                )
                if get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__CHANNEL_AXIS__TEST__INPUT) != "":
                    biapy_config["DATA"]["PREPROCESS"]["GAUSSIAN_BLUR"]["CHANNEL_AXIS"] = int(
                        get_text(main_window.ui.DATA__PREPROCESS__GAUSSIAN_BLUR__CHANNEL_AXIS__TEST__INPUT)
                    )
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__MEDIAN_BLUR__ENABLE__TEST__INPUT) == "Yes":
                ...
                try:
                    biapy_config["DATA"]["PREPROCESS"]["MEDIAN_BLUR"]["KERNEL_SIZE"] = ast.literal_eval(
                        get_text(main_window.ui.DATA__PREPROCESS__MEDIAN_BLUR__KERNEL_SIZE__TEST__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with preprocessing median blur kernel size field (DATA.PREPROCESS.MEDIAN_BLUR.KERNEL_SIZE). Please check its syntax!",
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__MATCH_HISTOGRAM__ENABLE__TEST__INPUT) == "Yes":
                ...
                biapy_config["DATA"]["PREPROCESS"]["MATCH_HISTOGRAM"]["ENABLE"] = True
                biapy_config["DATA"]["PREPROCESS"]["MATCH_HISTOGRAM"]["REFERENCE_PATH"] = get_text(
                    main_window.ui.DATA__PREPROCESS__MATCH_HISTOGRAM__REFERENCE_PATH__TEST__INPUT, strip=False
                )
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__CLAHE__ENABLE__TEST__INPUT) == "Yes":
                ...
                if get_text(main_window.ui.DATA__PREPROCESS__CLAHE__KERNEL_SIZE__TEST__INPUT) != "":
                    biapy_config["DATA"]["PREPROCESS"]["CLAHE"]["KERNEL_SIZE"] = int(
                        get_text(main_window.ui.DATA__PREPROCESS__CLAHE__KERNEL_SIZE__TEST__INPUT)
                    )
                biapy_config["DATA"]["PREPROCESS"]["CLAHE"]["CLIP_LIMIT"] = float(
                    get_text(main_window.ui.DATA__PREPROCESS__CLAHE__CLIP_LIMIT__TEST__INPUT)
                )
            ...
            if get_text(main_window.ui.DATA__PREPROCESS__CANNY__ENABLE__TEST__INPUT) == "Yes":
                ...
                if get_text(main_window.ui.DATA__PREPROCESS__CANNY__LOW_THRESHOLD__TEST__INPUT) != "":
                    biapy_config["DATA"]["PREPROCESS"]["CANNY"]["LOW_THRESHOLD"] = float(
                        get_text(main_window.ui.DATA__PREPROCESS__CANNY__LOW_THRESHOLD__TEST__INPUT)
                    )
    ...
    if get_text(main_window.ui.DATA__NORMALIZATION__PERC_CLIP__ENABLE__INPUT) == "Yes":
        ...
        biapy_config["DATA"]["NORMALIZATION"]["PERC_CLIP"]["LOWER_PERC"] = float(
            get_text(main_window.ui.DATA__NORMALIZATION__PERC_CLIP__LOWER_PERC__INPUT)
        )
        biapy_config["DATA"]["NORMALIZATION"]["PERC_CLIP"]["UPPER_PERC"] = float(
            get_text(main_window.ui.DATA__NORMALIZATION__PERC_CLIP__UPPER_PERC__INPUT)
        )

    if get_text(main_window.ui.DATA__NORMALIZATION__TYPE__INPUT) == "zero_mean_unit_variance":
        if "NORMALIZATION" not in biapy_config["DATA"]:
            biapy_config["DATA"]["NORMALIZATION"] = {}
        biapy_config["DATA"]["NORMALIZATION"]["TYPE"] = "zero_mean_unit_variance"
        biapy_config["DATA"]["NORMALIZATION"]["ZERO_MEAN_UNIT_VAR"]["MEAN_VAL"] = float(
            get_text(main_window.ui.DATA__NORMALIZATION__ZERO_MEAN_UNIT_VAR__MEAN_VAL__INPUT)
        )
        biapy_config["DATA"]["NORMALIZATION"]["ZERO_MEAN_UNIT_VAR"]["STD_VAL"] = float(
            get_text(main_window.ui.DATA__NORMALIZATION__ZERO_MEAN_UNIT_VAR__STD_VAL__INPUT)
        )
    ...
    if get_text(main_window.ui.TRAIN__ENABLE__INPUT) == "Yes":
        ...
        biapy_config["DATA"]["TRAIN"]["IN_MEMORY"] = (
            True if get_text(main_window.ui.DATA__TRAIN__IN_MEMORY__INPUT) == "Yes" else False
        )
        ...
        if (
            get_text(main_window.ui.DATA__TRAIN__RESOLUTION__INPUT) != "(1,1,1)"
            and get_text(main_window.ui.DATA__TRAIN__RESOLUTION__INPUT) != "(1,1)"
        ):
        ...
        if get_text(main_window.ui.DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA__INPUT) == "Yes":
            ...
            biapy_config["DATA"]["TRAIN"]["INPUT_ZARR_MULTIPLE_DATA_RAW_PATH"] = get_text(
                main_window.ui.DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA_RAW_PATH__INPUT
            )
            biapy_config["DATA"]["TRAIN"]["INPUT_ZARR_MULTIPLE_DATA_GT_PATH"] = get_text(
                main_window.ui.DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA_GT_PATH__INPUT
            )

        if get_text(main_window.ui.DATA__TRAIN__INPUT_IMG_AXES_ORDER__INPUT) != "TZCYX":
            biapy_config["DATA"]["TRAIN"]["INPUT_IMG_AXES_ORDER"] = get_text(
                main_window.ui.DATA__TRAIN__INPUT_IMG_AXES_ORDER__INPUT
            )

        if get_text(main_window.ui.DATA__TRAIN__INPUT_MASK_AXES_ORDER__INPUT) != "TZCYX":
            biapy_config["DATA"]["TRAIN"]["INPUT_MASK_AXES_ORDER"] = get_text(
                main_window.ui.DATA__TRAIN__INPUT_MASK_AXES_ORDER__INPUT
            )
        ...
        if get_text(main_window.ui.DATA__TRAIN__FILTER_SAMPLES__ENABLE__INPUT) == "Yes":
            ...
            try:
                biapy_config["DATA"]["TRAIN"]["FILTER_SAMPLES"]["PROPS"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__TRAIN__FILTER_SAMPLES__PROPS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with train data filter samples property array field (DATA.TRAIN.FILTER_SAMPLES.PROPS). Please check its syntax!",
                    reason="error",
                )
                return True, False
            try:
                biapy_config["DATA"]["TRAIN"]["FILTER_SAMPLES"]["VALUES"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__TRAIN__FILTER_SAMPLES__VALUES__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with train data filter samples values array field (DATA.TRAIN.FILTER_SAMPLES.VALUES). Please check its syntax!",
                    reason="error",
                )
                return True, False
            try:
                biapy_config["DATA"]["TRAIN"]["FILTER_SAMPLES"]["SIGNS"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__TRAIN__FILTER_SAMPLES__SIGNS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with train data filter samples signs array field (DATA.TRAIN.FILTER_SAMPLES.SIGNS). Please check its syntax!",
                    reason="error",
                )
                return True, False
            biapy_config["DATA"]["TRAIN"]["FILTER_SAMPLES"]["NORM_BEFORE"] = (
                True if get_text(main_window.ui.DATA__TRAIN__FILTER_SAMPLES__NORM_BEFORE__INPUT) == "Yes" else False
            )

        # Validation
        biapy_config["DATA"]["VAL"] = {}
        biapy_config["DATA"]["VAL"]["IN_MEMORY"] = (
            True if get_text(main_window.ui.DATA__VAL__IN_MEMORY__INPUT) == "Yes" else False
        )
        if get_text(main_window.ui.DATA__VAL__TYPE__INPUT) == "Extract from train (split training)":
            ...
            biapy_config["DATA"]["VAL"]["RANDOM"] = (
                True if get_text(main_window.ui.DATA__VAL__RANDOM__INPUT) == "Yes" else False
            )
            ...
            biapy_config["DATA"]["VAL"]["CROSS_VAL_NFOLD"] = int(
                get_text(main_window.ui.DATA__VAL__CROSS_VAL_NFOLD__INPUT)
            )
            biapy_config["DATA"]["VAL"]["CROSS_VAL_FOLD"] = int(
                get_text(main_window.ui.DATA__VAL__CROSS_VAL_FOLD__INPUT)
            )
            biapy_config["DATA"]["VAL"]["RANDOM"] = (
                True if get_text(main_window.ui.DATA__VAL__RANDOM__INPUT) == "Yes" else False
            )
        ...
        if get_text(main_window.ui.DATA__VAL__INPUT_ZARR_MULTIPLE_DATA__INPUT) == "Yes":
            ...
            biapy_config["DATA"]["VAL"]["INPUT_ZARR_MULTIPLE_DATA_RAW_PATH"] = get_text(
                main_window.ui.DATA__VAL__INPUT_ZARR_MULTIPLE_DATA_RAW_PATH__INPUT
            )
            biapy_config["DATA"]["VAL"]["INPUT_ZARR_MULTIPLE_DATA_GT_PATH"] = get_text(
                main_window.ui.DATA__VAL__INPUT_ZARR_MULTIPLE_DATA_GT_PATH__INPUT
            )

        if get_text(main_window.ui.DATA__VAL__INPUT_IMG_AXES_ORDER__INPUT) != "TZCYX":
            biapy_config["DATA"]["VAL"]["INPUT_IMG_AXES_ORDER"] = get_text(
                main_window.ui.DATA__VAL__INPUT_IMG_AXES_ORDER__INPUT
            )

        if get_text(main_window.ui.DATA__VAL__INPUT_MASK_AXES_ORDER__INPUT) != "TZCYX":
            biapy_config["DATA"]["VAL"]["INPUT_MASK_AXES_ORDER"] = get_text(
                main_window.ui.DATA__VAL__INPUT_MASK_AXES_ORDER__INPUT
            )
        ...
        if get_text(main_window.ui.DATA__VAL__FILTER_SAMPLES__ENABLE__INPUT) == "Yes":
            ...
            try:
                biapy_config["DATA"]["VAL"]["FILTER_SAMPLES"]["PROPS"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__VAL__FILTER_SAMPLES__PROPS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with val data filter samples property array field (DATA.VAL.FILTER_SAMPLES.PROPS). Please check its syntax!",
                    reason="error",
                )
                return True, False
            try:
                biapy_config["DATA"]["VAL"]["FILTER_SAMPLES"]["VALUES"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__VAL__FILTER_SAMPLES__VALUES__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with val data filter samples values array field (DATA.VAL.FILTER_SAMPLES.VALUES). Please check its syntax!",
                    reason="error",
                )
                return True, False
            try:
                biapy_config["DATA"]["VAL"]["FILTER_SAMPLES"]["SIGNS"] = ast.literal_eval(
                    get_text(main_window.ui.DATA__VAL__FILTER_SAMPLES__SIGNS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with val data filter samples signs array field (DATA.VAL.FILTER_SAMPLES.SIGNS). Please check its syntax!",
                    reason="error",
                )
                return True, False
            biapy_config["DATA"]["VAL"]["FILTER_SAMPLES"]["NORM_BEFORE"] = (
                True if get_text(main_window.ui.DATA__VAL__FILTER_SAMPLES__NORM_BEFORE__INPUT) == "Yes" else False
            )
        ...
        if get_text(main_window.ui.AUGMENTOR__ENABLE__INPUT) == "Yes":
            ...
            biapy_config["AUGMENTOR"]["AUG_SAMPLES"] = (
                True if get_text(main_window.ui.AUGMENTOR__AUG_SAMPLES__INPUT) == "Yes" else False
            )
            ...
            if int(get_text(main_window.ui.AUGMENTOR__AUG_NUM_SAMPLES__INPUT)) != 10:
                biapy_config["AUGMENTOR"]["AUG_NUM_SAMPLES"] = int(
                    get_text(main_window.ui.AUGMENTOR__AUG_NUM_SAMPLES__INPUT)
                )
            ...
            if get_text(main_window.ui.AUGMENTOR__RANDOM_ROT__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["RANDOM_ROT_RANGE"] = get_text(
                    main_window.ui.AUGMENTOR__RANDOM_ROT_RANGE__INPUT
                )
            ...
            if get_text(main_window.ui.AUGMENTOR__ZOOM__INPUT) == "Yes":
                ...
                if (
                    get_text(main_window.ui.PROBLEM__NDIM__INPUT) == "3D"
                    and get_text(main_window.ui.AUGMENTOR__ZOOM_IN_Z__INPUT) == "Yes"
                ):
            ...
            if (
                get_text(main_window.ui.AUGMENTOR__SHIFT__INPUT) == "Yes"
                or get_text(main_window.ui.AUGMENTOR__ZOOM__INPUT) == "Yes"
                or get_text(main_window.ui.AUGMENTOR__SHEAR__INPUT) == "Yes"
                or get_text(main_window.ui.AUGMENTOR__RANDOM_ROT__INPUT) == "Yes"
            ):
            ...
            if (
                get_text(main_window.ui.PROBLEM__NDIM__INPUT) == "3D"
                and get_text(main_window.ui.AUGMENTOR__ZFLIP__INPUT) == "Yes"
            ):
            ...
            if get_text(main_window.ui.AUGMENTOR__BRIGHTNESS__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["BRIGHTNESS_FACTOR"] = get_text(
                    main_window.ui.AUGMENTOR__BRIGHTNESS_FACTOR__INPUT
                )
                if get_text(main_window.ui.AUGMENTOR__BRIGHTNESS_MODE__INPUT) != "3D":
                    biapy_config["AUGMENTOR"]["BRIGHTNESS_MODE"] = get_text(
                        main_window.ui.AUGMENTOR__BRIGHTNESS_MODE__INPUT
                    )
            if get_text(main_window.ui.AUGMENTOR__CONTRAST__INPUT) == "Yes":
                biapy_config["AUGMENTOR"]["CONTRAST"] = True
                biapy_config["AUGMENTOR"]["CONTRAST_FACTOR"] = get_text(
                    main_window.ui.AUGMENTOR__CONTRAST_FACTOR__INPUT
                )
                if get_text(main_window.ui.AUGMENTOR__CONTRAST_MODE__INPUT) != "3D":
                    biapy_config["AUGMENTOR"]["CONTRAST_MODE"] = get_text(
                        main_window.ui.AUGMENTOR__CONTRAST_MODE__INPUT
                    )
            ...
            if get_text(main_window.ui.AUGMENTOR__CUTOUT__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["COUT_NB_ITERATIONS"] = get_text(
                    main_window.ui.AUGMENTOR__COUT_NB_ITERATIONS__INPUT
                )
                ...
                biapy_config["AUGMENTOR"]["COUT_APPLY_TO_MASK"] = (
                    True if get_text(main_window.ui.AUGMENTOR__COUT_APPLY_TO_MASK__INPUT) == "Yes" else False
                )
            if get_text(main_window.ui.AUGMENTOR__CUTBLUR__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["CBLUR_DOWN_RANGE"] = get_text(
                    main_window.ui.AUGMENTOR__CBLUR_DOWN_RANGE__INPUT
                )
                biapy_config["AUGMENTOR"]["CBLUR_INSIDE"] = (
                    True if get_text(main_window.ui.AUGMENTOR__CBLUR_INSIDE__INPUT) == "Yes" else False
                )
            ...
            if get_text(main_window.ui.AUGMENTOR__CUTNOISE__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["CNOISE_NB_ITERATIONS"] = get_text(
                    main_window.ui.AUGMENTOR__CNOISE_NB_ITERATIONS__INPUT
                )
            ...
            if get_text(main_window.ui.AUGMENTOR__MISALIGNMENT__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["MS_DISPLACEMENT"] = int(
                    get_text(main_window.ui.AUGMENTOR__MS_DISPLACEMENT__INPUT)
                )
                biapy_config["AUGMENTOR"]["MS_ROTATE_RATIO"] = float(
                    get_text(main_window.ui.AUGMENTOR__MS_ROTATE_RATIO__INPUT)
                )
            if get_text(main_window.ui.AUGMENTOR__MISSING_SECTIONS__INPUT) == "Yes":
                biapy_config["AUGMENTOR"]["MISSING_SECTIONS"] = True
                biapy_config["AUGMENTOR"]["MISSP_ITERATIONS"] = get_text(
                    main_window.ui.AUGMENTOR__MISSP_ITERATIONS__INPUT
                )
            ...
            if get_text(main_window.ui.AUGMENTOR__GRIDMASK__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["GRID_INVERT"] = (
                    True if get_text(main_window.ui.AUGMENTOR__GRID_INVERT__INPUT) == "Yes" else False
                )
            if get_text(main_window.ui.AUGMENTOR__GAUSSIAN_NOISE__INPUT) == "Yes":
                biapy_config["AUGMENTOR"]["GAUSSIAN_NOISE"] = True
                biapy_config["AUGMENTOR"]["GAUSSIAN_NOISE_MEAN"] = float(
                    get_text(main_window.ui.AUGMENTOR__GAUSSIAN_NOISE_MEAN__INPUT)
                )
                biapy_config["AUGMENTOR"]["GAUSSIAN_NOISE_VAR"] = float(
                    get_text(main_window.ui.AUGMENTOR__GAUSSIAN_NOISE_VAR__INPUT)
                )
                biapy_config["AUGMENTOR"]["GAUSSIAN_NOISE_USE_INPUT_IMG_MEAN_AND_VAR"] = (
                    True
                    if get_text(main_window.ui.AUGMENTOR__GAUSSIAN_NOISE_USE_INPUT_IMG_MEAN_AND_VAR__INPUT) == "Yes"
                    else False
                )
            ...
            if get_text(main_window.ui.AUGMENTOR__PEPPER__INPUT) == "Yes":
                ...
                biapy_config["AUGMENTOR"]["PEPPER_AMOUNT"] = float(
                    get_text(main_window.ui.AUGMENTOR__PEPPER_AMOUNT__INPUT)
                )
            if get_text(main_window.ui.AUGMENTOR__SALT_AND_PEPPER__INPUT) == "Yes":
                biapy_config["AUGMENTOR"]["SALT_AND_PEPPER"] = True
                biapy_config["AUGMENTOR"]["SALT_AND_PEPPER_AMOUNT"] = float(
                    get_text(main_window.ui.AUGMENTOR__SALT_AND_PEPPER_AMOUNT__INPUT)
                )
                biapy_config["AUGMENTOR"]["SALT_AND_PEPPER_PROP"] = float(
                    get_text(main_window.ui.AUGMENTOR__SALT_AND_PEPPER_PROP__INPUT)
                )
        else:
            if get_text(main_window.ui.AUTOMATIC__AUG__INPUT) == "Manually":
                ...
                if workflow_key_name in ["SEMANTIC_SEG", "INSTANCE_SEG", "DETECTION", "IMAGE_TO_IMAGE"]:
                    biapy_config["AUGMENTOR"]["BRIGHTNESS"] = True
    ...
    if get_text(main_window.ui.TEST__ENABLE__INPUT) == "Yes":
        ...
        biapy_config["DATA"]["TEST"]["IN_MEMORY"] = (
            True if get_text(main_window.ui.DATA__TEST__IN_MEMORY__INPUT) == "Yes" else False
        )
        if (
            get_text(main_window.ui.DATA__TEST__USE_VAL_AS_TEST__INPUT) == "Yes"
            and get_text(main_window.ui.DATA__VAL__TYPE__INPUT) == "Extract from train (cross validation)"
        ):
            ...
            if get_text(main_window.ui.DATA__TEST__LOAD_GT__INPUT) == "Yes":
                ...
                if workflow_key_name not in ["DENOISING", "SELF_SUPERVISED", "CLASSIFICATION"]:
                    biapy_config["DATA"]["TEST"]["GT_PATH"] = get_text(
                        main_window.ui.DATA__TEST__GT_PATH__INPUT, strip=False
                    )
            else:
    ...
    biapy_config["MODEL"] = {}
    if not (
        get_text(main_window.ui.LOAD_PRETRAINED_MODEL__INPUT) == "Yes"
        and get_text(main_window.ui.MODEL__SOURCE__INPUT) != "I have a model trained with BiaPy"
    ):
        model_name = main_window.cfg.translate_model_names(
            get_text(main_window.ui.MODEL__ARCHITECTURE__INPUT), get_text(main_window.ui.PROBLEM__NDIM__INPUT)
        )
        biapy_config["MODEL"]["ARCHITECTURE"] = model_name
        if model_name in ["unet", "resunet", "resunet++", "seunet", "attention_unet"]:
            try:
                biapy_config["MODEL"]["FEATURE_MAPS"] = ast.literal_eval(
                    get_text(main_window.ui.MODEL__FEATURE_MAPS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error in model's feature maps field (MODEL.FEATURE_MAPS). Please check its syntax!",
                    reason="error",
                )
                return True, False
            try:
                biapy_config["MODEL"]["DROPOUT_VALUES"] = ast.literal_eval(
                    get_text(main_window.ui.MODEL__DROPOUT_VALUES__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error in model's dropout values field (MODEL.DROPOUT_VALUES). Please check its syntax!",
                    reason="error",
                )
                return True, False
            ...
            if get_text(main_window.ui.PROBLEM__NDIM__INPUT) == "3D":
                try:
                    ...
                    main_window.dialog_exec(
                        "There was an error in model's z axis downsampling  field (MODEL.Z_DOWN). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
            if get_text(main_window.ui.MODEL__ISOTROPY__INPUT) != "[True, True, True, True, True]":
                try:
                    biapy_config["MODEL"]["ISOTROPY"] = ast.literal_eval(
                        get_text(main_window.ui.MODEL__ISOTROPY__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error in model's isotropy field (MODEL.ISOTROPY). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
            ...
            if workflow_key_name == "SUPER_RESOLUTION" and get_text(main_window.ui.PROBLEM__NDIM__INPUT) == "3D":  # SR
                r = (
                    "pre"
                    if get_text(main_window.ui.MODEL__UNET_SR_UPSAMPLE_POSITION__INPUT) == "Before model"
                    else "post"
                )
            ...
            if model_name in "unetr":
                biapy_config["MODEL"]["UNETR_VIT_HIDD_MULT"] = int(
                    get_text(main_window.ui.MODEL__UNETR_VIT_HIDD_MULT__INPUT)
                )
                biapy_config["MODEL"]["UNETR_VIT_NUM_FILTERS"] = int(
                    get_text(main_window.ui.MODEL__UNETR_VIT_NUM_FILTERS__INPUT)
                )
                biapy_config["MODEL"]["UNETR_DEC_ACTIVATION"] = get_text(
                    main_window.ui.MODEL__UNETR_DEC_ACTIVATION__INPUT
                )
                biapy_config["MODEL"]["UNETR_DEC_KERNEL_SIZE"] = int(
                    get_text(main_window.ui.MODEL__UNETR_DEC_KERNEL_SIZE__INPUT)
                )
            ...
            # MAE
                ...
                if get_text(main_window.ui.MODEL__MAE_MASK_TYPE__INPUT) == "random":
                    biapy_config["MODEL"]["MAE_MASK_RATIO"] = float(
                        get_text(main_window.ui.MODEL__MAE_MASK_RATIO__INPUT)
                    )
                biapy_config["MODEL"]["MAE_DEC_HIDDEN_SIZE"] = int(
                    get_text(main_window.ui.MODEL__MAE_DEC_HIDDEN_SIZE__INPUT)
                )
                biapy_config["MODEL"]["MAE_DEC_NUM_LAYERS"] = int(
                    get_text(main_window.ui.MODEL__MAE_DEC_NUM_LAYERS__INPUT)
                )
        ...
        if workflow_key_name in ["SEMANTIC_SEG", "INSTANCE_SEG", "DETECTION", "CLASSIFICATION"]:
            ...
            if workflow_key_name == "SEMANTIC_SEG" and int(get_text(main_window.ui.MODEL__N_CLASSES__INPUT)) != 2:
                ...
                workflow_key_name == "INSTANCE_SEG"
                and int(get_text(main_window.ui.MODEL__N_CLASSES__INST_SEG__INPUT)) != 2
            ):
    ...
    if get_text(main_window.ui.LOAD_PRETRAINED_MODEL__INPUT) == "Yes":
        if get_text(main_window.ui.MODEL__SOURCE__INPUT) == "I have a model trained with BiaPy":
            ...
            biapy_config["PATHS"] = {}
            if (
                get_text(main_window.ui.PATHS__CHECKPOINT_FILE__INPUT) != ""
                and get_text(main_window.ui.PATHS__CHECKPOINT_FILE__INPUT) != "model_weights.pth"
            ):
                biapy_config["PATHS"]["CHECKPOINT_FILE"] = get_text(
                    main_window.ui.PATHS__CHECKPOINT_FILE__INPUT, strip=False
                )
            ...
            if get_text(main_window.ui.MODEL__LOAD_CHECKPOINT_EPOCH__INPUT) != "best_on_val":
                biapy_config["MODEL"]["LOAD_CHECKPOINT_EPOCH"] = get_text(
                    main_window.ui.MODEL__LOAD_CHECKPOINT_EPOCH__INPUT
                )
            if get_text(main_window.ui.MODEL__LOAD_CHECKPOINT_ONLY_WEIGHTS__INPUT) != "Yes":
                biapy_config["MODEL"]["LOAD_CHECKPOINT_ONLY_WEIGHTS"] = get_text(
                    main_window.ui.MODEL__LOAD_CHECKPOINT_ONLY_WEIGHTS__INPUT
                )
            ...
            if get_text(main_window.ui.MODEL__BMZ__SOURCE_MODEL_ID__INPUT) != "":
                ...
                main_window.dialog_exec(
                    "Please, select an external model by clicking on 'Check models' button in 'Generic options' window.",
                    reason="error",
                )
                return True, False
    ...
    if get_text(main_window.ui.MODEL__BMZ__EXPORT__ENABLE__INPUT) == "Yes":
        ...
        if model_src == "bmz" and get_text(main_window.ui.MODEL__BMZ__EXPORT__REUSE_BMZ_CONFIG__INPUT) == "Yes":
            ...
            biapy_config["MODEL"]["BMZ"]["EXPORT"]["MODEL_NAME"] = get_text(
                main_window.ui.MODEL__BMZ__EXPORT__MODEL_NAME__INPUT
            )
            biapy_config["MODEL"]["BMZ"]["EXPORT"]["DESCRIPTION"] = get_text(
                main_window.ui.MODEL__BMZ__EXPORT__DESCRIPTION__INPUT
            )
            biapy_config["MODEL"]["BMZ"]["EXPORT"]["LICENSE"] = get_text(
                main_window.ui.MODEL__BMZ__EXPORT__LICENSE__INPUT
            )
            biapy_config["MODEL"]["BMZ"]["EXPORT"]["MODEL_VERSION"] = get_text(
                main_window.ui.MODEL__BMZ__EXPORT__MODEL_VERSION__INPUT
            )
            if (
                get_text(main_window.ui.MODEL_AUTOGENERATE_DOC_INPUT) == "No"
                and get_text(main_window.ui.MODEL__BMZ__EXPORT__DOCUMENTATION__INPUT) != ""
            ):
                biapy_config["MODEL"]["BMZ"]["EXPORT"]["DOCUMENTATION"] = get_text(
                    main_window.ui.MODEL__BMZ__EXPORT__DOCUMENTATION__INPUT
                )
            if get_text(main_window.ui.MODEL__BMZ__EXPORT__AUTHORS__INPUT) != "":
                try:
                    biapy_config["MODEL"]["BMZ"]["EXPORT"]["AUTHORS"] = ast.literal_eval(
                        get_text(main_window.ui.MODEL__BMZ__EXPORT__AUTHORS__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with BMZ authors field (MODEL.BMZ.EXPORT.AUTHORS). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
            if get_text(main_window.ui.MODEL__BMZ__EXPORT__TAGS__INPUT) != "":
                try:
                    biapy_config["MODEL"]["BMZ"]["EXPORT"]["TAGS"] = ast.literal_eval(
                        get_text(main_window.ui.MODEL__BMZ__EXPORT__TAGS__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with BMZ tags field (MODEL.BMZ.EXPORT.TAGS). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
            if get_text(main_window.ui.MODEL__BMZ__EXPORT__CITE__INPUT) != "":
                try:
                    biapy_config["MODEL"]["BMZ"]["EXPORT"]["CITE"] = ast.literal_eval(
                        get_text(main_window.ui.MODEL__BMZ__EXPORT__CITE__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with BMZ citation field (MODEL.BMZ.EXPORT.CITE). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
            if get_text(main_window.ui.MODEL__BMZ__EXPORT__DATASET_INFO__INPUT) != "":
                try:
                    biapy_config["MODEL"]["BMZ"]["EXPORT"]["DATASET_INFO"] = ast.literal_eval(
                        get_text(main_window.ui.MODEL__BMZ__EXPORT__DATASET_INFO__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with BMZ citation field (MODEL.BMZ.EXPORT.DATASET_INFO). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
    ...
    if biapy_config["LOSS"]["TYPE"] == "W_CE_DICE":
        try:
            ...
            main_window.dialog_exec(
                "There was an error with loss weights field (LOSS.WEIGHTS). Please check its syntax!", reason="error"
            )
            return True, False
    biapy_config["LOSS"]["CLASS_REBALANCE"] = (
        True if get_text(main_window.ui.LOSS__CLASS_REBALANCE__INPUT) == "Yes" else False
    )
    ...
    try:
        ...
        main_window.dialog_exec(
            "There was an error with train metrics field (TRAIN.METRICS). Please check its syntax!", reason="error"
        )
        return True, False
    ...
    if get_text(main_window.ui.TRAIN__ENABLE__INPUT) == "Yes":
        ...
        if get_text(main_window.ui.TRAIN__BATCH_SIZE__CALCULATION__INPUT) == "Yes":
            try:
                ...
                main_window.dialog_exec(
                    "There was an error with the patch size formating (DATA.PATCH_SIZE). Please check its syntax!",
                    reason="error",
                )
                return True, False
            ...
            if biapy_config["PROBLEM"]["TYPE"] == "CLASSIFICATION":
                ...
                if biapy_config["PROBLEM"]["TYPE"] in ["DENOISING", "SUPER_RESOLUTION", "IMAGE_TO_IMAGE"]:
            ...
            if total_samples == 1:
                ...
                try:
                    ...
                    masking = False
                if biapy_config["PROBLEM"]["TYPE"] != "DENOISING" and not masking:
                    try:
        ...
        if get_text(main_window.ui.TRAIN__LR_SCHEDULER__NAME__INPUT) != "":
            ...
            if get_text(main_window.ui.TRAIN__LR_SCHEDULER__NAME__INPUT) in ["warmupcosine", "reduceonplateau"]:
                biapy_config["TRAIN"]["LR_SCHEDULER"]["MIN_LR"] = float(
                    get_text(main_window.ui.TRAIN__LR_SCHEDULER__MIN_LR__INPUT)
                )
            if get_text(main_window.ui.TRAIN__LR_SCHEDULER__NAME__INPUT) == "reduceonplateau":
                biapy_config["TRAIN"]["LR_SCHEDULER"]["REDUCEONPLATEAU_FACTOR"] = float(
                    get_text(main_window.ui.TRAIN__LR_SCHEDULER__REDUCEONPLATEAU_FACTOR__INPUT)
                )
                biapy_config["TRAIN"]["LR_SCHEDULER"]["REDUCEONPLATEAU_PATIENCE"] = int(
                    get_text(main_window.ui.TRAIN__LR_SCHEDULER__REDUCEONPLATEAU_PATIENCE__INPUT)
                )
            if get_text(main_window.ui.TRAIN__LR_SCHEDULER__NAME__INPUT) == "warmupcosine":
                biapy_config["TRAIN"]["LR_SCHEDULER"]["WARMUP_COSINE_DECAY_EPOCHS"] = int(
                    get_text(main_window.ui.TRAIN__LR_SCHEDULER__WARMUP_COSINE_DECAY_EPOCHS__INPUT)
                )

        # Set LR scheduler by default if default epochs and patience
        if (
            biapy_config["TRAIN"]["EPOCHS"] == 150
            and biapy_config["TRAIN"]["PATIENCE"] == 50
            and get_text(main_window.ui.TRAIN__LR_SCHEDULER__NAME__INPUT) == ""
        ):
            if "LR_SCHEDULER" not in biapy_config["TRAIN"]:
                biapy_config["TRAIN"]["LR_SCHEDULER"] = {}
            biapy_config["TRAIN"]["LR_SCHEDULER"]["NAME"] = "warmupcosine"
            biapy_config["TRAIN"]["LR_SCHEDULER"]["MIN_LR"] = 1.0e-5
    ...
    if get_text(main_window.ui.TEST__ENABLE__INPUT) == "Yes":
        ...
        if (
            get_text(main_window.ui.TEST__ANALIZE_2D_IMGS_AS_3D_STACK__INPUT) == "Yes"
            and get_text(main_window.ui.PROBLEM__NDIM__INPUT) == "2D"
        ):
            biapy_config["TEST"]["ANALIZE_2D_IMGS_AS_3D_STACK"] = True

        if (
            get_text(main_window.ui.TEST__FULL_IMG__INPUT) == "Yes"
            and get_text(main_window.ui.PROBLEM__NDIM__INPUT) == "2D"
        ):
        ...
        if get_text(main_window.ui.TEST__BY_CHUNKS__ENABLE__INPUT) == "Yes":
            ...
            if get_text(main_window.ui.TEST__BY_CHUNKS__WORKFLOW_PROCESS__ENABLE__INPUT) == "Yes":
                ...
                biapy_config["TEST"]["BY_CHUNKS"]["WORKFLOW_PROCESS"]["TYPE"] = get_text(
                    main_window.ui.TEST__BY_CHUNKS__WORKFLOW_PROCESS__TYPE__INPUT
                )

        ### Instance segmentation
        if workflow_key_name == "INSTANCE_SEG":
            biapy_config["TEST"]["MATCHING_STATS"] = (
                True if get_text(main_window.ui.TEST__MATCHING_STATS__INPUT) == "Yes" else False
            )
            try:
                biapy_config["TEST"]["MATCHING_STATS_THS"] = ast.literal_eval(
                    get_text(main_window.ui.TEST__MATCHING_STATS_THS__INPUT)
                )
            except:
                main_window.dialog_exec(
                    "There was an error with test matching start thresholds field (TEST.MATCHING_STATS_THS). Please check its syntax!",
                    reason="error",
                )
                return True, False
            if get_text(main_window.ui.TEST__MATCHING_STATS_THS_COLORED_IMG__INPUT) != "[0.3]":
                try:
                    biapy_config["TEST"]["MATCHING_STATS_THS_COLORED_IMG"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__MATCHING_STATS_THS_COLORED_IMG__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test matching start thresholds colored image field (TEST.MATCHING_STATS_THS_COLORED_IMG). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
        ...
        ### Detection
            ...
            biapy_config["TEST"]["DET_POINT_CREATION_FUNCTION"] = get_text(
                main_window.ui.TEST__DET_POINT_CREATION_FUNCTION__INPUT
            )
            biapy_config["TEST"]["DET_MIN_TH_TO_BE_PEAK"] = float(
                get_text(main_window.ui.TEST__DET_MIN_TH_TO_BE_PEAK__INPUT)
            )
            biapy_config["TEST"]["DET_EXCLUDE_BORDER"] = (
                True if get_text(main_window.ui.TEST__DET_EXCLUDE_BORDER__INPUT) == "Yes" else False
            )
            ...
            if get_text(main_window.ui.TEST__DET_IGNORE_POINTS_OUTSIDE_BOX__INPUT) != "[]":
                try:
                    biapy_config["TEST"]["DET_IGNORE_POINTS_OUTSIDE_BOX"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__DET_IGNORE_POINTS_OUTSIDE_BOX__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test detection ignore points outside box field (TEST.DET_IGNORE_POINTS_OUTSIDE_BOX). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
            if get_text(main_window.ui.TEST__DET_POINT_CREATION_FUNCTION__INPUT) == "blob_log":
                biapy_config["TEST"]["DET_BLOB_LOG_MIN_SIGMA"] = int(
                    get_text(main_window.ui.TEST__DET_BLOB_LOG_MIN_SIGMA__INPUT)
                )
                biapy_config["TEST"]["DET_BLOB_LOG_MAX_SIGMA"] = int(
                    get_text(main_window.ui.TEST__DET_BLOB_LOG_MAX_SIGMA__INPUT)
                )
                biapy_config["TEST"]["DET_BLOB_LOG_NUM_SIGMA"] = int(
                    get_text(main_window.ui.TEST__DET_BLOB_LOG_NUM_SIGMA__INPUT)
                )
        ...
        if workflow_key_name == "SEMANTIC_SEG":
            if get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER__SEM_SEG__INPUT) == "Yes":
                ...
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["MEDIAN_FILTER_AXIS"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER_AXIS__SEM_SEG__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing median filter axis field (TEST.POST_PROCESSING.MEDIAN_FILTER_AXIS). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["MEDIAN_FILTER_SIZE"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER_SIZE__SEM_SEG__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing median filter size field (TEST.POST_PROCESSING.MEDIAN_FILTER_SIZE). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
        ### Instance segmentation
            ...
            if get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER__INST_SEG__INPUT) == "Yes":
                ...
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["MEDIAN_FILTER_AXIS"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER_AXIS__INST_SEG__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing median filter axis field (TEST.POST_PROCESSING.MEDIAN_FILTER_AXIS). Please check its syntax!",
                ...
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["MEDIAN_FILTER_SIZE"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER_SIZE__INST_SEG__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing median filter size field (TEST.POST_PROCESSING.MEDIAN_FILTER_SIZE). Please check its syntax!",
                    ...
                    return True, False
            if (
                problem_channels in ["BC", "BCM"]
                and get_text(main_window.ui.TEST__POST_PROCESSING__VORONOI_ON_MASK__INPUT) == "Yes"
            ):
                biapy_config["TEST"]["POST_PROCESSING"]["VORONOI_ON_MASK"] = True
                biapy_config["TEST"]["POST_PROCESSING"]["VORONOI_TH"] = float(
                    get_text(main_window.ui.TEST__POST_PROCESSING__VORONOI_TH__INPUT)
                )
            if get_text(main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__ENABLE__INST_SEG__INPUT) == "Yes":
                ...
                if (
                    get_text(
                        main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__ENABLE__INST_SEG__INPUT
                    )
                    == "Yes"
                ):
                    ...
                    try:
                        biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"][
                            ...
                            get_text(
                                main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__PROPS__INST_SEG__INPUT
                            )
                        )
                    except:
                        main_window.dialog_exec(
                            "There was an error with test post processing measure properties, removing my properties, in properties array field (TEST.POST_PROCESSING.MEASURE_PROPERTIES.REMOVE_BY_PROPERTIES.PROPS). Please check its syntax!",
                            reason="error",
                        )
                        return True, False
                    try:
                        biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"][
                            ...
                            get_text(
                                main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__VALUES__INST_SEG__INPUT
                            )
                        )
                    except:
                        main_window.dialog_exec(
                            "There was an error with test post processing measure properties, removing my properties, in values array field (TEST.POST_PROCESSING.MEASURE_PROPERTIES.REMOVE_BY_PROPERTIES.VALUES). Please check its syntax!",
                            reason="error",
                        )
                        return True, False
                    try:
                        biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"][
                            ...
                            get_text(
                                main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__SIGNS__INST_SEG__INPUT
                            )
                        )
                    except:
                        main_window.dialog_exec(
                            "There was an error with test post processing measure properties, removing my properties, in signs array field (TEST.POST_PROCESSING.MEASURE_PROPERTIES.REMOVE_BY_PROPERTIES.SIGNS). Please check its syntax!",
                            reason="error",
                        )
                        return True, False
            if problem_channels == "BP":
                if int(get_text(main_window.ui.TEST__POST_PROCESSING__REPARE_LARGE_BLOBS_SIZE__INPUT)) != -1:
                    biapy_config["TEST"]["POST_PROCESSING"]["REPARE_LARGE_BLOBS_SIZE"] = int(
                        get_text(main_window.ui.TEST__POST_PROCESSING__REPARE_LARGE_BLOBS_SIZE__INPUT)
                    )
                if get_text(main_window.ui.TEST__POST_PROCESSING__REMOVE_CLOSE_POINTS__INST_SEG__INPUT) == "Yes":
                    ...
                    biapy_config["TEST"]["POST_PROCESSING"]["REMOVE_CLOSE_POINTS_RADIUS"] = int(
                        get_text(main_window.ui.TEST__POST_PROCESSING__REMOVE_CLOSE_POINTS_RADIUS__INST_SEG__INPUT)
                    )
        ### Detection
        elif workflow_key_name == "DETECTION":
            if get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER__DET__INPUT) == "Yes":
                ...
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["MEDIAN_FILTER_AXIS"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER_AXIS__DET__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing median filter axis field (TEST.POST_PROCESSING.MEDIAN_FILTER_AXIS). Please check its syntax!",
                ...
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["MEDIAN_FILTER_SIZE"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__MEDIAN_FILTER_SIZE__DET__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing median filter size field (TEST.POST_PROCESSING.MEDIAN_FILTER_SIZE). Please check its syntax!",
            ...
            if get_text(main_window.ui.TEST__POST_PROCESSING__REMOVE_CLOSE_POINTS__DET__INPUT) == "Yes":
                biapy_config["TEST"]["POST_PROCESSING"]["REMOVE_CLOSE_POINTS"] = True
                biapy_config["TEST"]["POST_PROCESSING"]["REMOVE_CLOSE_POINTS_RADIUS"] = int(
                    get_text(main_window.ui.TEST__POST_PROCESSING__REMOVE_CLOSE_POINTS_RADIUS__DET__INPUT)
                )
            if get_text(main_window.ui.TEST__POST_PROCESSING__DET_WATERSHED__INPUT) == "Yes":
                ...
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["DET_WATERSHED_FIRST_DILATION"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__DET_WATERSHED_FIRST_DILATION__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing detection watershed first dilation field (TEST.POST_PROCESSING.DET_WATERSHED_FIRST_DILATION). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["DET_WATERSHED_DONUTS_CLASSES"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__DET_WATERSHED_DONUTS_CLASSES__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing detection watershed donuts classes field (TEST.POST_PROCESSING.DET_WATERSHED_DONUTS_CLASSES). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
                try:
                    biapy_config["TEST"]["POST_PROCESSING"]["DET_WATERSHED_DONUTS_PATCH"] = ast.literal_eval(
                        get_text(main_window.ui.TEST__POST_PROCESSING__DET_WATERSHED_DONUTS_PATCH__INPUT)
                    )
                except:
                    main_window.dialog_exec(
                        "There was an error with test post processing detection watershed donuts patch field (TEST.POST_PROCESSING.DET_WATERSHED_DONUTS_PATCH). Please check its syntax!",
                        reason="error",
                    )
                    return True, False
                biapy_config["TEST"]["POST_PROCESSING"]["DET_WATERSHED_DONUTS_NUCLEUS_DIAMETER"] = int(
                    get_text(main_window.ui.TEST__POST_PROCESSING__DET_WATERSHED_DONUTS_NUCLEUS_DIAMETER__INPUT)
                )
                if get_text(main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__ENABLE__DET__INPUT) == "Yes":
                    ...
                    if (
                        get_text(
                            main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__ENABLE__DET__INPUT
                        )
                        == "Yes"
                    ):
                        biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"] = {}
                        ...
                        try:
                            biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"][
                                ...
                                get_text(
                                    main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__PROPS__DET__INPUT
                                )
                            )
                        except:
                            main_window.dialog_exec(
                        ...
                        try:
                            biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"][
                                ...
                                get_text(
                                    main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__VALUES__DET__INPUT
                                )
                            )
                        except:
                            main_window.dialog_exec(
                        ...
                        try:
                            biapy_config["TEST"]["POST_PROCESSING"]["MEASURE_PROPERTIES"]["REMOVE_BY_PROPERTIES"][
                                ...
                                get_text(
                                    main_window.ui.TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__SIGNS__DET__INPUT
                                )
                            )
                        except:
                            main_window.dialog_exec(
    ...
    if main_window.external_model_restrictions is not None:
        ...
        for key, val in main_window.external_model_restrictions.items():
            ...
            m += f"    - {key} : {val}\n"
        main_window.dialog_exec(
            "The following variables will be set automatically as they are imposed by the pretrained model selected:\n"
            + m,
            "inform_user",
        )
    ...
    if not main_window.cfg.settings["yaml_config_filename"].endswith(".yaml") and not main_window.cfg.settings[
    ...
    if os.path.exists(
        ...
        main_window.yes_no_exec(
            "The file '{}' already exists. Do you want to overwrite it?".format(
                main_window.cfg.settings["yaml_config_filename"]
            )
        )
        assert main_window.yes_no
        replace = True if main_window.yes_no.answer else False
...
class load_yaml_to_GUI_engine(QObject):
    ...
    def __init__(self, main_window: main.MainWindow, yaml_file: str, thread_queue: queue.Queue):
        ...
        self.white_list = [
            "DATA__VAL__CROSS_VAL__INPUT",
            "DATA__TEST__BINARY_MASKS__INPUT",
            "DATA__TEST__DETECTION_MASK_DIR__INPUT",
            "DATA__TEST__INSTANCE_CHANNELS_DIR__INPUT",
            "DATA__TEST__INSTANCE_CHANNELS_MASK_DIR__INPUT",
            "DATA__TEST__SSL_SOURCE_DIR__INPUT",
            "DATA__TRAIN__DETECTION_MASK_DIR__INPUT",
            "DATA__TRAIN__INSTANCE_CHANNELS_DIR__INPUT",
            "DATA__TRAIN__INSTANCE_CHANNELS_MASK_DIR__INPUT",
            "DATA__TRAIN__SSL_SOURCE_DIR__INPUT",
            "DATA__VAL__DETECTION_MASK_DIR__INPUT",
            "DATA__VAL__INSTANCE_CHANNELS_DIR__INPUT",
            "DATA__VAL__INSTANCE_CHANNELS_MASK_DIR__INPUT",
            "DATA__VAL__SSL_SOURCE_DIR__INPUT",
            "LOG__CHART_CREATION_FREQ__INPUT",
            "LOG__LOG_DIR__INPUT",
            "LOG__LOG_FILE_PREFIX__INPUT",
            "LOG__TENSORBOARD_LOG_DIR__INPUT",
            "SYSTEM__NUM_GPUS__INPUT",
            # Handled with different names
            "MODEL__LOAD_CHECKPOINT__INPUT",
            "MODEL__SOURCE__INPUT",
            "MODEL__TORCHVISION_MODEL_NAME__INPUT",
            # Not used or decided to not insert in GUI
            "SYSTEM__PIN_MEM__INPUT",
            "TRAIN__CHECKPOINT_MONITOR__INPUT",
            "DATA__VAL__DIST_EVAL__INPUT",
            "MODEL__VIT_MODEL__INPUT",
            "SYSTEM__DEVICE",
            "DATA__PREPROCESS__ZOOM",
            "DATA__PREPROCESS__ZOOM__ENABLE",
            "DATA__PREPROCESS__ZOOM__ZOOM_FACTOR",
            "DATA__TRAIN__FILTER_SAMPLES__SIGNS",
            "PROBLEM__DENOISING__LOAD_GT_DATA",
            "DATA__FILTER_BY_IMAGE",
            "DATA__SAVE_FILTERED_IMAGES",
            "DATA__SAVE_FILTERED_IMAGES_NUM",
            "MODEL__LOAD_MODEL_FROM_CHECKPOINT__INPUT",
            # Synapse stuff is experimental
            "PROBLEM__INSTANCE_SEG__SYNAPSES__DATA_CHANNELS",
            "PROBLEM__INSTANCE_SEG__SYNAPSES__POSTSITE_DILATION",
            "PROBLEM__INSTANCE_SEG__SYNAPSES__POSTSITE_DILATION_DISTANCE_CHANNELS",
            "PROBLEM__INSTANCE_SEG__SYNAPSES__NORMALIZE_DISTANCES",
            "DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA_ID_PATH",
            "DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA_PARTNERS_PATH",
            "DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA_LOCATIONS_PATH",
            "DATA__TRAIN__INPUT_ZARR_MULTIPLE_DATA_RESOLUTION_PATH",
            "DATA__VAL__INPUT_ZARR_MULTIPLE_DATA_ID_PATH",
            "DATA__VAL__INPUT_ZARR_MULTIPLE_DATA_PARTNERS_PATH",
            "DATA__VAL__INPUT_ZARR_MULTIPLE_DATA_LOCATIONS_PATH",
            "DATA__VAL__INPUT_ZARR_MULTIPLE_DATA_RESOLUTION_PATH",
            "DATA__TEST__INPUT_ZARR_MULTIPLE_DATA_ID_PATH",
            "DATA__TEST__INPUT_ZARR_MULTIPLE_DATA_PARTNERS_PATH",
            "DATA__TEST__INPUT_ZARR_MULTIPLE_DATA_LOCATIONS_PATH",
            "DATA__TEST__INPUT_ZARR_MULTIPLE_DATA_RESOLUTION_PATH",
        ]
    ...
    def run(self):
        ...
        try:
            with open(self.yaml_file, "r", encoding="utf8") as stream:
                ...
                if "\t" in cfg_content:
                    tab_detected_mss = (
                        "WARNING: Tabs have been identified and substituted with two spaces. This error may be "
            ...
            self.bmz_pretrained = (
                tmp_cfg["MODEL"]["SOURCE"] == "bmz" and tmp_cfg["MODEL"]["BMZ"]["SOURCE_MODEL_ID"] != ""
            )

            # Torchvision pretrained model
            self.torchvision_pretrained = (
                tmp_cfg["MODEL"]["SOURCE"] == "torchvision" and tmp_cfg["MODEL"]["TORCHVISION_MODEL_NAME"] != ""
            )
        ...
        for k, v in conf.items():
            if isinstance(v, dict):
                ...
                if widget_name == "DATA__VAL__FROM_TRAIN__INPUT":
                    ...
                    widget_name = "TEST__POST_PROCESSING__MEASURE_PROPERTIES__ENABLE__{}__INPUT".format(
                        self.workflow_str
                    )
                elif widget_name == "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__ENABLE__INPUT":
                    widget_name = (
                        "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__ENABLE__{}__INPUT".format(
                            self.workflow_str
                        )
                    )
                elif widget_name == "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__PROPS__INPUT":
                    widget_name = (
                        "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__PROPS__{}__INPUT".format(
                            self.workflow_str
                        )
                    )
                elif widget_name == "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__VALUES__INPUT":
                    widget_name = (
                        "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__VALUES__{}__INPUT".format(
                            self.workflow_str
                        )
                    )
                elif widget_name == "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__SIGNS__INPUT":
                    widget_name = (
                        "TEST__POST_PROCESSING__MEASURE_PROPERTIES__REMOVE_BY_PROPERTIES__SIGNS__{}__INPUT".format(
                            self.workflow_str
                        )
                    )
                    ...
                    widget_name = "TEST__POST_PROCESSING__REMOVE_CLOSE_POINTS_RADIUS__{}__INPUT".format(
                        self.workflow_str
                    )
                ...
                if "DATA__PREPROCESS__" in widget_name and widget_name not in [
                    ...
                    if self.train_preprocessing or self.val_preprocessing:
                        if self.test_preprocessing:
                            aux = (
                                widget_name
                                if "__TEST" in widget_name
                                else widget_name.replace("__INPUT", "__TEST__INPUT")
                            )
