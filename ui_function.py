...
class UIFunction(MainWindow):
    ...
    def init_train_page(self):        
        ...
        self.ui.adamw_weight_decay_input.setVisible(False)
    ...
    def model_combobox_changed(self, model_name):
        if model_name in ['unet', 'resunet', 'seunet', 'attention_unet']:
            ...
            if model_name == "unetr":
                ...
                self.ui.unetr_vit_hidden_multiple_input.setVisible(True)
                self.ui.unetr_num_filters_label.setVisible(True)
                self.ui.unetr_num_filters_input.setVisible(True)
                self.ui.unetr_dec_act_label.setVisible(True)
                self.ui.unetr_dec_act_input.setVisible(True)
                self.ui.unetr_dec_kernel_init_label.setVisible(True)
                self.ui.unetr_dec_kernel_init_input.setVisible(True)
            else:
                self.ui.unetr_vit_hidden_multiple_label.setVisible(False)
                self.ui.unetr_vit_hidden_multiple_input.setVisible(False)
                self.ui.unetr_num_filters_label.setVisible(False)
                self.ui.unetr_num_filters_input.setVisible(False)
                self.ui.unetr_dec_act_label.setVisible(False)
                self.ui.unetr_dec_act_input.setVisible(False)
                self.ui.unetr_dec_kernel_init_label.setVisible(False)
                self.ui.unetr_dec_kernel_init_input.setVisible(False)
                if model_name == "ViT":
    ...
    def init_test_page(self):
        ...
        self.ui.inst_seg_b_channel_th_input.setVisible(False)
        self.ui.inst_seg_c_channel_th_label.setVisible(False)
        self.ui.inst_seg_c_channel_th_input.setVisible(False)
        self.ui.inst_seg_fore_mask_th_label.setVisible(False)
        self.ui.inst_seg_fore_mask_th_input.setVisible(False)
